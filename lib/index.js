...
import { openAssistantSession } from './assistant-session.js'
  ...
  ctx.effect(
    () => ctx.webServer.register({
      ...
      handler: artifactsHandler(store, {
        ...
        openAssistantSession: () => openAssistantSession(ctx.apiProxy, store),
      }),
    }),
